    ...
    <div className="flex mt-10 justify-center">
      <div className="md:grid md:grid-cols-3 md:gap-4 lg:grid lg:grid-cols-4 lg:gap-6 px-3">
        {data.map((characters) => (
          <div
            key={characters._id}
            className="sm:mt-3 flex md:flex-col rounded-lg overflow-hidden md:max-w-[295px] bg-slate-300 md:opacity-70 md:hover:opacity-100 md:hover:translate-y-[-3px] transition shadow-md shadow-black/30"
          >
